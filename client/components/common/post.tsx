...
export default function Post(props: Props) {
	...
	const hidePost = (e: React.MouseEvent<HTMLDivElement>) =>
		(e.target as HTMLDivElement).id === "post-image-container" &&
		setPost(false);
	...
	return (
		<div
					...
					{user.user?._id === props.author ? (
						<div
							...
							<div className="flex w-full max-w-[300px]  flex-col rounded-md bg-white font-bold ">
								<button className="border-b border-neutral-200 py-4 text-violet-500">
									Edit
								</button>
								<button className="border-b border-neutral-200 py-4 text-red-500">
									Delete
								</button>
								<button
									className="py-4"
						...
						<div
							...
							<div className="flex w-full max-w-[300px]  flex-col rounded-md bg-white font-bold ">
								...
								<button className="border-b border-neutral-200 py-4">
									Share
								</button>
								<button className="border-b border-neutral-200 py-4">
									Go to post
			...
			<div
				className={`comments-box  h-full w-[500px] bg-white  phone:w-full phone:min-w-0`}>
