...
export default function Post(props: Props) {
	...
	return (
		<div id="post-modal" className="fixed top-0 left-0 z-50 flex h-full w-full bg-black/80 phone:flex-col phone:overflow-y-auto phone:bg-neutral-100" onClick={hidePost}>
			...
			<div id="post-image-container" className={` relative  flex h-full w-full items-center justify-center p-10 phone:mt-[83px] phone:p-0 `} onClick={hidePost}>
				...
				<div className=" post-image-container flex h-full items-center justify-center bg-gray-700">
			...
			<div className={`comments-box  h-full w-[500px] bg-white  phone:w-full phone:min-w-0`}>
				...
				<div className={`space-y-5  overflow-y-auto bg-neutral-100   p-5 ${width > 600 && "h-[calc(100%-(83px+65px))]"} phone:pb-[85px]`}>
						...
						return (
							<div key={postIndex} className="flex gap-2  ">
								<div className="flex max-w-[32px] flex-col items-center  gap-2  pb-2">
									...
									<div className={`h-full rounded-bl-lg border-l   border-b border-neutral-300  ${show === postIndex ? "ml-14 w-14" : "ml-4 w-4"}`}></div>
								</div>
				...
				<div className="flex w-full  flex-col  items-center gap-2  border-t border-neutral-200 phone:hidden">
					<div className="flex w-full  items-center  justify-between gap-2 border-t border-neutral-200 p-5">
						...
						<input type="text" placeholder="Add a comment..." className="h-full w-full text-sm placeholder:text-neutral-400" value={text} onChange={input} />
